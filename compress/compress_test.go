...
func TestDetectFormat(t *testing.T) {
	tests := map[string]Format{
		...
		"file.CSV.GZ":   FormatGzip,
		"file.csv.zst":  FormatZstd,
		"file.csv.zstd": FormatZstd,
		"file.CSV.ZST":  FormatZstd,
	}
...
func TestZstdRoundTrip(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, "out.csv.zst")
...
func TestStreamWriterZstd(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, "stream.csv.zst")
...
func TestStreamReaderZstd(t *testing.T) {
	dir := t.TempDir()
	path := filepath.Join(dir, "read.csv.zst")
